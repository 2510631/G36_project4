# Group 36: Yizhou Huang (s2510631), Houyuan Long (s2485299), Wenhao Yan (s2493934)
# Github Repo: https://github.com/2510631/G36_project4.git

# Contribution:
# Yizhou Huang (s2510631): netup + backward functions
# Houyuan Long (s2485299) : forward function + train 4873
# Wenhao Yan (s2493934) : train + predict functions
# We initially analysed and discussed the problem and made comments together.
...
# Five functions can be seen in this project, including 'netup' function for 
# setting up the network architecture, 'forward' and 'backward' functions for 
# performing forward and backward propagation, 'train' function for training the
# network and 'predict' function for making predictions on new data.


netup = function (d){
  # The purpose of this function is to initialize a neural network with the 
  # specified layer sizes, providing initial values for nodes, weight matrices, 
  # and offset vectors.
...
# Set seed for reproducibility during training
set.seed(6666)
